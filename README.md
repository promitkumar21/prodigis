...
<head>
    ...
    <title>ProDigits — Calculator</title>
    ...
    <style>
        ...
        * {
        ...
        body.theme-midnight .pricing-card.active {
            background: #ffffff;
            border-color: #ffffff !important;
        }

        body.theme-midnight .pricing-card.active .plan-name,
        body.theme-midnight .pricing-card.active .plan-desc {
            color: var(--text-secondary);
        }

        body.theme-midnight .pricing-card.active .plan-price {
            color: var(--text-primary);
        }

        body.theme-midnight .pricing-card.active .badge {
            background: #1a1a1a;
            color: #fff;
        }

        body.theme-frost .pricing-card.active {
            background: rgba(255, 255, 255, 0.95);
            border-color: rgba(255, 255, 255, 0.95) !important;
        }

        body.theme-frost .pricing-card.active .plan-name,
        body.theme-frost .pricing-card.active .plan-desc {
            color: #1a1a1a;
            opacity: 0.8;
        }

        body.theme-frost .pricing-card.active .plan-price {
            color: #1a1a1a;
        }

        body.theme-frost .pricing-card.active .badge {
            background: #1a1a1a;
            color: #fff;
        }

        body.theme-neon .pricing-card.active {
            background: linear-gradient(135deg, #ff00aa, #00f0ff);
            border-color: transparent !important;
        }

        body.theme-neon .pricing-card.active .plan-name,
        body.theme-neon .pricing-card.active .plan-desc {
            color: #ffffff;
            opacity: 0.9;
        }

        body.theme-neon .pricing-card.active .plan-price {
            color: #ffffff;
        }

        body.theme-neon .pricing-card.active .badge {
            background: #ffffff;
            color: #ff00aa;
        }
        ...
        @media (max-width: 480px) {
            ...
            .calculator-card {
                ...
                flex-direction: column;
                justify-content: space-between;
                padding: calc(20px + env(safe-area-inset-top, 0px)) 20px calc(24px + env(safe-area-inset-bottom, 0px)) 20px;
                animation: none;
                box-shadow: none;
        ...
        @media (max-width: 360px) {
            .calculator-card {
                padding: calc(12px + env(safe-area-inset-top, 0px)) 16px calc(16px + env(safe-area-inset-bottom, 0px)) 16px;
            }
    ...
    <script>
      ...
      `).join('');
        ...
        function selectPlan(plan) {
            ...
            const clickedCard = document.getElementById('plan-' + plan);
            if (clickedCard) {
